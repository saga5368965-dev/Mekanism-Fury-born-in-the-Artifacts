...
public class ModelBusterThrower extends MekanismJavaModel {
    ...
    private final RenderType RENDER_TYPE = renderType(BUSTER_THROWER_TEXTURE);
    private final List<ModelPart> parts;

    public ModelBusterThrower(EntityModelSet entityModelSet) {
        super(RenderType::entitySolid);
        ModelPart root = entityModelSet.bakeLayer(BUSTER_THROWER_LAYER);
    ...
    public void render(@NotNull PoseStack matrix, @NotNull MultiBufferSource renderer, int light, int overlayLight, boolean hasEffect) {
        renderToBuffer(matrix, getVertexConsumer(renderer, RENDER_TYPE, hasEffect), light, overlayLight, 1.0F, 1.0F, 1.0F, 1.0F);
    }
